...
export const Header = () => (
  <header className={section({ centerish: true })}>
    ...
    <p className="">
      کارم ساخت وب‌اپ‌های ساده، سریع و با کیفیت با استفاده از ابزارهای مدرن هست.
      به رشد مستمر و کدنویسی تمیز علاقه‌مندم و همیشه در تلاش برای بهبود مهارت‌ها و
      تجربیاتی هستم که خلق می‌کنم.
    </p>
